...
<html>
<head>
    <title>Добавить грузовик</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 p-8">
    <div class="max-w-3xl mx-auto bg-white rounded shadow p-6">
        <h1 class="text-2xl font-bold mb-6">Добавить грузовик</h1>
        ...
        <form action="{{ route('admin.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="brand" value="{{ old('brand') }}" class="w-full border rounded px-3 py-2" required>
                </div>

                <div class="mb-4">
                    <label class="block text-sm font-medium mb-1">Модель *</label>
                    <input type="text" name="model" value="{{ old('model') }}" class="w-full border rounded px-3 py-2" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="price" value="{{ old('price') }}" class="w-full border rounded px-3 py-2" required step="0.01">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="engine" value="{{ old('engine') }}" class="w-full border rounded px-3 py-2" placeholder="Например: 12.5л, 450 л.с.">
                </div>

                <div class="mb-4">
                    <label class="block text-sm font-medium mb-1">Трансмиссия</label>
                    <input type="text" name="transmission" value="{{ old('transmission') }}" class="w-full border rounded px-3 py-2" placeholder="Например: Механика, 6 ступеней">
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="number" name="mileage" value="{{ old('mileage') }}" class="w-full border rounded px-3 py-2" placeholder="Например: 150000">
                </div>
            ...
            <div class="flex gap-2 mt-4">
                <button type="submit" class="bg-orange-500 text-white px-6 py-2 rounded hover:bg-orange-600">Сохранить</button>
